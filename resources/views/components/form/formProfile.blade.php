<form id="{{$form_id}}" action="#" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-lg col-md">
            {{-- Tanggal Lahir --}}
            @component('components.formGroup.input', ['label' => 'Tanggal Lahir (contoh: 31-12-2022)', 'type' => 'text', 'class' => 'tanggal', 'id' => 'tanggal-lahir', 'name' => 'tanggal_lahir', 'placeholder' => 'Masukkan', 'value' => $profile->tanggal_lahir ?? null])
            @endcomponent
        </div>
    </div>
