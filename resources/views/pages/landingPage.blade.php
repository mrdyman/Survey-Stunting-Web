    ...
    <nav class="navbar navbar-expand-lg navbar-light">
      <div class="container">
        ...
        <a class="navbar-brand" href="./index.html">
          <img src="{{asset('assets/landingPage')}}/img/brand.svg" class="navbar-brand-img" alt="...">
        </a>
            ...
            <div class="card shadow-light-lg overflow-hidden" data-aos="fade-up">
              <div class="row">
                <div class="col-md-4 position-relative">
                  ...
                  <!-- Image -->
                  <img src="{{asset('assets/landingPage')}}/img/illustrations/illustration-8.png" class="h-75 position-absolute right-0 mt-7 me-n4" alt="...">
            ...
            <div class="card shadow-light-lg overflow-hidden text-center" data-aos="fade-up">
              <div class="row">
                ...
                <div class="col-md-4">
                  ...
                  <!-- Image -->
                  <img src="{{asset('assets/landingPage')}}/img/illustrations/illustration-6.png" class="h-75 position-absolute left-0 mt-7" alt="...">
            ...
            <div class="card shadow-light-lg overflow-hidden text-center text-lg-start" data-aos="fade-up">
              <div class="row">
                <div class="col-md-4 position-relative">
                  ...
                  <!-- Image -->
                  <img src="{{asset('assets/landingPage')}}/img/illustrations/illustration-2.png" class="h-75 position-absolute right-0 mt-6" alt="...">
            ...
            <div class="w-md-130">
              <div class="device-combo device-combo-iphonex-macbook">
                ...
                <div class="device device-iphonex">
                  <img src="{{asset('assets/landingPage')}}/img/screenshots/mobile/dashkit-alt.jpg" class="device-screen" alt="...">
                  <img src="{{asset('assets/landingPage')}}/img/devices/iphonex.svg" class="img-fluid" alt="...">
                </div>

                <!-- Macbook -->
                <div class="device device-macbook">
                  <img src="{{asset('assets/landingPage')}}/img/screenshots/desktop/dashkit-alt.jpg" class="device-screen" alt="...">
                  <img src="{{asset('assets/landingPage')}}/img/devices/macbook.svg" class="img-fluid" alt="...">
                </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 col-md-4 col-lg-3">
            ...
            <!-- Brand -->
            <img src="{{asset('assets/landingPage')}}/img/brand.svg" alt="..." class="footer-brand img-fluid mb-2">
            ...
            <ul class="list-unstyled list-inline list-social mb-6 mb-md-0">
              <li class="list-inline-item list-social-item me-3">
                <a href="#!" class="text-decoration-none">
                  <img src="{{asset('assets/landingPage')}}/img/icons/social/instagram.svg" class="list-social-icon" alt="...">
                </a>
              </li>
              <li class="list-inline-item list-social-item me-3">
                <a href="#!" class="text-decoration-none">
                  <img src="{{asset('assets/landingPage')}}/img/icons/social/facebook.svg" class="list-social-icon" alt="...">
                </a>
              </li>
              <li class="list-inline-item list-social-item me-3">
                <a href="#!" class="text-decoration-none">
                  <img src="{{asset('assets/landingPage')}}/img/icons/social/twitter.svg" class="list-social-icon" alt="...">
                </a>
              </li>
              <li class="list-inline-item list-social-item">
                <a href="#!" class="text-decoration-none">
                  <img src="{{asset('assets/landingPage')}}/img/icons/social/pinterest.svg" class="list-social-icon" alt="...">
                </a>
              </li>
            </ul>
