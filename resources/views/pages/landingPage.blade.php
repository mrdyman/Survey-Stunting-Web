      ...
      <div class="container">
        <div class="row align-items-center text-center text-md-start">
          <div class="col-12 col-md-5 col-lg-6 order-md-1">
            ...
            <!-- Image -->
            <img src="{{asset('assets/landingPage')}}/img/illustrations/survey.png" alt="..." class="img-fluid mw-110 float-end mb-6 mb-md-0" data-aos="fade-right">
        ...
        <div class="row">
          <div class="col-12 col-md-6 text-center" data-aos="fade-up" data-aos-delay="50">
            ...
            <div class="icon text-danger mb-3">
              <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><g fill="none" fill-rule="evenodd"><path d="M0 0h24v24H0z"></path><path d="M18 2h2a3 3 0 013 3v14a3 3 0 01-3 3h-2V2z" fill="#335EEA" opacity=".3"></path><path d="M5 2h12a3 3 0 013 3v14a3 3 0 01-3 3H5a1 1 0 01-1-1V3a1 1 0 011-1zm7 9a2 2 0 100-4 2 2 0 000 4zm-5 5.5c-.011.162.265.5.404.5h9.177c.418 0 .424-.378.418-.5-.163-3.067-2.348-4.5-5.008-4.5-2.623 0-4.775 1.517-4.99 4.5z" fill="#335EEA"></path></g></svg>         </div>
          ...
          <div class="col-12 col-md-6 text-center" data-aos="fade-up" data-aos-delay="100">
            ...
            <!-- Icon -->
            <div class="icon text-danger mb-3">
              <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><g fill="none" fill-rule="evenodd"><path d="M0 0h24v24H0z"></path><path d="M12 21a9 9 0 110-18 9 9 0 010 18zm2.165-13.645l-4.554 3.007a.5.5 0 00-.224.388l-.327 5.448a.5.5 0 00.775.447l4.554-3.007a.5.5 0 00.224-.388l.327-5.448a.5.5 0 00-.775-.447z" fill="#335EEA"></path></g></svg>           </div>
            ...
            <p class="text-muted mb-0">
              <i class="fe fe-map-pin"></i> Jl. R.A. Kartini No.100, Lolu Sel., Kec. Palu Sel., Kota Palu, Sulawesi Tengah 94111
            </p>
        ...
        <div class="row">
          <div class="col">
            ...
            <p class="text-center text-muted small mb-0">
              &copy; @php
                echo date('Y');
              @endphp <a href="https://disp2kb.sultengprov.go.id/" target="_blank" class="text-muted">Dinas Pengendalian Penduduk dan Keluarga Berencana Sulawesi Tengah</a>
