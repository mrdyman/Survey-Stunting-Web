                ...
                <div class="card-body ">
                    <div class="row">
                        ...
                        <div class="col-8 col-stats">
                            <div class="numbers">
                                <p class="card-category">Total Data Survey</p>
            ...
            <div class="card card-stats card-round">
                <div class="card-body ">
                    <div class="row">
                        ...
                        <div class="col-8 col-stats">
                            <div class="numbers">
                                <p class="card-category">Total Surveyor</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-8 col-stats">
                            <div class="numbers">
                                ...
                                <h4 class="card-title">{{$totalResponden}}</h4>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-head-row">
                        <div class="card-title w-100">
                            Statistik Pengisian Survey
                            <div class="float-right">
                                <select class="form-control" id='tahun' name="tahun">
                                    @forelse ($daftarTahun as $item)
                ...
                <div class="card-body">
                    ...
                    <ul class="0-legend html-legend my-0">
                        <li><span style="background-color:#FFAD46"></span>Pre</li>
                        <li><span style="background-color:#34CE39"></span>Post</li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-tools">
                            <ul class="nav nav-pills nav-secondary nav-pills-no-bd nav-sm" id="pills-tab" role="tablist">
                                <li class="nav-item" style="float: right">
                                    <a href="#v-pills-today" class="nav-link active show" id="pills-today" data-toggle="pill" href="#pills-today" role="tab" aria-selected="true">Hari Ini ({{ $riwayatSurveyHariIni->count() }}) </a>
                                </li>
                                <li class="nav-item" style="float: right">
                                    <a href="#v-pills-weeks" class="nav-link" id="pills-week" data-toggle="pill" href="#pills-week" role="tab" aria-selected="false">Seminggu Terakhir ({{ $riwayatSurveyMingguIni->count() }})</a>
                                </li>
                                <li class="nav-item" style="float: right">
                                    <a href="#v-pills-month" class="nav-link" id="pills-month" data-toggle="pill" href="#pills-month" role="tab" aria-selected="false">Sebulan Terakhir ({{ $riwayatSurveyBulanIni->count() }})</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            @forelse ($riwayatSurveyHariIni->get() as $item)
                                <div class="d-flex">
                                    <div class="flex-1 ml-3 pt-1">
                                        <h6 class="text-uppercase mb-1">Surveyor: {{$item->profile->nama_lengkap}} </h6>
                                        <h6 class="text-uppercase fw-bold mb-0">Responden: {{$item->responden->kartu_keluarga}} 
                                        @if ($item->namaSurvey->tipe == 'Pre')
                                            <span class="badge badge-danger ml-3">Pre</span>
                                        @else
                                            <span class="badge badge-success ml-3">Post</span>
                                        @endif
                                        <span class="text-muted d-block">Judul: {{$item->namaSurvey->nama}} </span>
                                    </div>
                                    <div class="float-right pt-1">
                                        <small class="text-muted">{{$item->created_at->diffForHumans()}}</small>
                                        <div>
                                            <a href="{{ url('/survey/lihat-survey/') }}/{{$item->id}}" class="badge badge-primary mt-1 float-right text-white" target="_blank">Lihat</a>
                                        </div>
                                    </div>
                                </div>
