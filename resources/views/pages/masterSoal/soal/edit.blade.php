                    ...
                    @foreach ($isiSoal->jawabanSoal as $jawaban)
                        ...
                        @else
                            <div class='input-group mt-2' id='tambahkan-lainnya-pilihan-ganda-ubah'>
                                <div class='input-group-text'>
                                    <input type="text" value="{{ $jawaban->id }}" id="id-lainnya" name="id_jawaban_ubah[]"
                                        hidden>
                                    <input class='form-check-input mt-0' type='radio'
                                        aria-label='Radio button for following text input' onclick='return false' />
                                </div><input name='jawaban_ubah[]' value='Lainnya' type='text' class='form-control'
                                    aria-label='Text input with radio button' placeholder='Lainnya...' readonly /><button
                                    type="button" class='btn btn-danger'
                                    onclick='hapusLainnyaPilihanGandaUbah({{ $jawaban->id }})'><i
                    ...
                    @foreach ($isiSoal->jawabanSoal as $jawaban)
                        ...
                        @else
                            <div class='input-group mt-2' id='tambahkan-lainnya-kotak-centang-ubah'>
                                <div class='input-group-text'>
                                    <input type="text" value="{{ $jawaban->id }}" id="id-lainnya"
                                        name="id_jawaban_ubah[]" hidden>
                                    <input class='form-check-input mt-0' type='radio'
                                        aria-label='Radio button for following text input' onclick='return false' />
                                </div><input name='jawaban_ubah[]' value='Lainnya' type='text' class='form-control'
                                    aria-label='Text input with radio button' placeholder='Lainnya...' readonly /><button
                                    type="button" class='btn btn-danger'
                                    onclick='hapusLainnyaKotakCentangUbah({{ $jawaban->id }})'><i
                                        class='fas fa-times'></i></button>
                            </div>
                        @endif
                    @endforeach
