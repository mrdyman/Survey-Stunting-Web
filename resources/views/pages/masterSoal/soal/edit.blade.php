        ...
        <div class="col-lg-12" id="jawaban-pertanyaan">
            ...
            <div class='input-group mt-2' id='tambahkan-lainnya-pilihan-ganda-ubah'>
                <div class='input-group-text'>
                    ...
                    <input class='form-check-input mt-0' type='radio' aria-label='Radio button for following text input'
                        onclick='return false' /></div><input name='jawaban_ubah[]' value='Lainnya' type='text'
                    class='form-control' aria-label='Text input with radio button' placeholder='Lainnya...'
                    readonly /><button type="button" class='btn btn-danger'
                    onclick='hapusLainnyaPilihanGandaUbah({{$jawaban->id}})'><i class='fas fa-times'></i></button>
            </div>
            @endif
            @endforeach
            @if ($jawaban->jawaban == "Lainnya")
            ...
            <div class='input-group mt-2' id='tambahkan-lainnya-kotak-centang-ubah'>
                <div class='input-group-text'>
                    ...
                    class='form-control' aria-label='Text input with radio button' placeholder='Lainnya...'
                    readonly /><button type="button" class='btn btn-danger'
                    onclick='hapusLainnyaKotakCentangUbah({{$jawaban->id}})'><i class='fas fa-times'></i></button>
            </div>
            @endif
            @endforeach
            @if ($jawaban->jawaban == "Lainnya")
            ...
            @endif
            @else
            <input type='text' class='form-control' id='' placeholder='Text Jawaban Singkat' readonly />
            @endif
        </div>
    </div>
